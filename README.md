...
3. **CIE76 Delta-E Calculation**: Calculates color difference (&Delta;E) between target color (L₁*, a₁*, b₁*) and candidate markers (L₂*, a₂*, b₂*) using standard Euclidean distance in L*a*b* space:
